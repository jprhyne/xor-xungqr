*> \brief \b DORG2R_REF generates all or part of the orthogonal matrix Q from a QR factorization determined by sgeqrf (unblocked algorithm).
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download DORG2R_REF + dependencies
...
*  ===========
*
*       SUBROUTINE DORG2R_REF( M, N, K, A, LDA, TAU, WORK, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DORG2R_REF generates an m by n real matrix Q with orthonormal columns,
