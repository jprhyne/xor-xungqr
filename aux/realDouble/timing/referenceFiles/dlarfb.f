*> \brief \b DLARFB_REF applies a block reflector or its transpose to a general rectangular matrix.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download DLARFB_REF + dependencies
...
*  ===========
*
*       SUBROUTINE DLARFB_REF( SIDE, TRANS, DIRECT, STOREV, M, N, K, V, LDV,
...
*> \verbatim
*>
*> DLARFB_REF applies a real block reflector H or its transpose H**T to a
...
*>
*  =====================================================================
      SUBROUTINE DLARFB_REF( SIDE, TRANS, DIRECT, STOREV, M, N, K, V,
     $                   LDV,
     $                   T, LDT, C, LDC, WORK, LDWORK )
      IMPLICIT NONE
*
