...
*
*> Download DORGL2_REF + dependencies
...
*  ===========
*
*       SUBROUTINE DORGL2_REF( M, N, K, A, LDA, TAU, WORK, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DORGL2_REF generates an m by n real matrix Q with orthonormal rows,
