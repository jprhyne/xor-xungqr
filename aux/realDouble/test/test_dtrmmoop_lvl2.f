      PROGRAM TEST_DTRMMOOP_LVL2
         ! Scalars
         INTEGER           I,J,K,L,M,N,O,MN,II,IJ
         CHARACTER         VERB_CHAR
         LOGICAL           TERMINATE,VERBOSE
         DOUBLE PRECISION  NORM_ERR, NORM_C, ALPHA, BETA, TMP
         ! Arrays
         DOUBLE PRECISION, ALLOCATABLE :: A(:,:), As(:,:), B(:,:),
     $      Bs(:,:), C(:,:), Cs(:,:)
         CHARACTER :: SIDES(2), UPLOS(2), TRANSAS(3), TRANSBS(3),
     $      DIAGS(2)
         ! External subroutines
         EXTERNAL          DTRMMOOP, DTRMMOOP_LVL2, DLACPY
         ! External Functions
         ...
         WRITE(*,*) "Provide a value for M and N to DTRMMOOP_LVL2"
         READ(*,*) M, N
     ...
     $      " no"
         ...
         DO O = 1, 2 ! DIAGS   = ['U', 'N']
            ...
            CALL DLACPY('All', MN, MN, A, MN, As, MN)
            CALL DLACPY('All', MN, MN, B, MN, Bs, MN)
            ...
            ! implementation
            CALL DTRMMOOP_LVL2(SIDES(I), UPLOS(J), TRANSAS(K),
     ...
     $               DIAGS(O), M, N, ALPHA, A, MN, B, MN, BETA, Cs, M)
               ...
               END DO
               END DO
               NORM_ERR = DLANGE('F', M, N, C, M, C) / NORM_C
