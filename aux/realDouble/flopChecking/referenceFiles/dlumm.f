...
*  ===========
*
*     RECURSIVE SUBROUTINE DLUMM_CNT(SIDEL, DIAGL, DIAGU, N, ALPHA,
*    $                        A, LDA)
*
*     .. Scalar Arguments ..
*     INTEGER           N, LDA
...
*
            CALL DLUMM_CNT(SIDEL, DIAGL, DIAGU, N-K, ALPHA,
     $               A(K+1, K+1), LDA, CNT)
*
...
*
            CALL DLUMM_CNT(SIDEL, DIAGL, DIAGU, K, ALPHA, A, LDA, CNT)
         ELSE
*
*        This means we are computing
*                         |---------------|   |---------------|
