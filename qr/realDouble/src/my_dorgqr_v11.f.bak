c
c     This file is version 9 with taking the T factor as an input
c        parameter
c
*> \brief \b DORGQR
*
...
*
*  =====================================================================
      SUBROUTINE MY_DORGQR_V11( M, N, K, A, LDA, TAU, WORK, LWORK, INFO)
      IMPLICIT NONE
      ! A contains T in the upper triangular part
*
...
*
      IF( KK.GT.0 ) THEN
*------------------------------------------------------------------------
*        First block guaranteed of size NB
*------------------------------------------------------------------------
         I = KK + 1
         IB = NB
*
...
*        A
*
         CALL COMPUTE_Q2(M, N, K, KI, NB, A, LDA, TAU)
*        Now, we compute the rest of our Q (Q1).
         DO 50 I = KI + 1, 1, -NB
            IB = NB
*
*           Form the triangular factor of the block reflector
...
*                                                    ( C2=* )
*
            CALL MY_DLARFB(M-I+1, K-(I+IB)+1, IB, A(I,I), LDA, 
     $         A(I,I+IB), LDA)
*
*           Apply H to rows i:m of current block
*
