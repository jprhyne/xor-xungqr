...
*
*  =====================================================================
      SUBROUTINE MY_DGESVD( JOBU, JOBVT, M, N, A, LDA, S, U, LDU,
...
*           Compute space needed for DORGQR
            CALL MY_DORGQR( M, N, N, A, LDA, DUM(1), DUM(1), -1, IERR )
            LWORK_DORGQR_N = INT( DUM(1) )
            CALL MY_DORGQR( M, M, N, A, LDA, DUM(1), DUM(1), -1, IERR )
...
*                 (Workspace: need N*N + 2*N, prefer N*N + N + N*NB)
*
                  CALL MY_DORGQR( M, N, N, A, LDA, WORK( ITAU ),
     $                         WORK( IWORK ), LWORK-IWORK+1, IERR )
                  IE = ITAU
                  ITAUQ = IE + N
                  ITAUP = ITAUQ + N
...
*                    (Workspace: need 2*N, prefer N + N*NB)
*
                     CALL MY_DORGQR( M, N, N, U, LDU, WORK( ITAU ),
     $                            WORK( IWORK ), LWORK-IWORK+1, IERR )
                     IE = ITAU
                     ITAUQ = IE + N
                     ITAUP = ITAUQ + N
...
*
                     CALL MY_DORGQR( M, M, N, U, LDU, WORK( ITAU ),
     $                            WORK( IWORK ), LWORK-IWORK+1, IERR )
                     IE = ITAU
                     ITAUQ = IE + N
                     ITAUP = ITAUQ + N
