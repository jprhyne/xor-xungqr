*> \brief \b SLARFT_REC forms the triangular factor T of a block reflector H = I - vtvH
*
*  =========== DOCUMENTATION ===========
*
...
*
*> Download SLARFT_REC + dependencies
...
*  ===========
*
*       RECURSIVE SUBROUTINE SLARFT_REC( DIRECT, STOREV, N, K, V, LDV, TAU, T, LDT )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> SLARFT_REC forms the triangular factor T of a real block reflector H
...
*>
*  =====================================================================
      RECURSIVE SUBROUTINE SLARFT_REC( DIRECT, STOREV, N, K, V, LDV,
     $                             TAU, T, LDT )
*
...
*
         CALL SLARFT_REC(DIRECT, STOREV, N, L, V, LDV, TAU, T, LDT)
*
*        Compute T_{2,2} recursively
*
         CALL SLARFT_REC(DIRECT, STOREV, N-L, K-L, V(L+1, L+1), LDV, 
...
*        Compute T_{1,1} recursively
*
         CALL SLARFT_REC(DIRECT, STOREV, N-L, K-L, V, LDV, TAU, T, LDT)
*
*        Compute T_{2,2} recursively
*
         CALL SLARFT_REC(DIRECT, STOREV, N, L, V(1, K-L+1), LDV,
...
*        Compute T_{2,2} recursively
*
         CALL SLARFT_REC(DIRECT, STOREV, N, L, V(K-L+1, 1), LDV,
     $               TAU(K-L+1), T(K-L+1, K-L+1), LDT)
*
*        Compute T_{2,1}
*        T_{2,1} = V_{2,2}
